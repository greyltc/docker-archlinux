...
```
curl --location --silent https://github.com/greyltc/docker-archlinux/releases/download/v20220114.0.104/docker-archlinux-x86_64.tar.xz | docker build --tag arch-localbuild -
```
### From scratch
