...
pacman --noconfirm -Sy --force coreutils bash grep gawk file tar sed acl archlinux-keyring attr bzip2 curl e2fsprogs expat gcc-libs-multilib glibc gpgme icu keyutils krb5 libarchive libassuan libgpg-error libnghttp2 libpsl libssh2 lz4 openssl pacman pacman-mirrorlist xz zlib filesystem dash
